...
//done with player 2
public class MoveInReverseTrad {
	...
	public static void moveInReverse()
	{
		...
		{	
				MonopolyRunner.player2TurnTrad();
	...
	public static void moveInReverse2()
	{
		...
		{	
			MonopolyRunner.player1TurnTrad();
	...
	public static void initialMove()
	{
		...
		System.out.println("Since you are moving in reverse, you landed on " + BoardArrayList.tradBoard.get(reverseNewPlace).getName());
		MonopolyRunner.player1.setPlace(reverseNewPlace);
		MoveAroundTrad.doAction();
	}
	...
	public static void otherMoves()
	{
		...
		if(reverseInventoryDecision == 1)
		{
			...
			else if(MonopolyRunner.player1.getPlace() - Dice.diceRoll < 0)
			{
				...
				System.out.println("You are on: " + BoardArrayList.tradBoard.get(reverseNewPlace3 + 1).getName());
				MoveAroundTrad.doAction();
			}
			else
			{
	...
	public static void otherMoves2()
	{
		...
		if(reverseInventoryDecisionP2 == 1)
		{
			...
			else if(MonopolyRunner.player2.getPlace() - Dice.diceRoll < 0)
			{
				...
				System.out.println("You are on: " + BoardArrayList.tradBoard.get(reverseNewPlace3P2 + 1).getName());
				MoveAroundTrad.doAction2();
			}
			else
			{
