		...
		public static void fillListTradition()
			{
				...
				boardList.add(new Board("Go", 0 , 0, false));
				boardList.add(new Board("Mediterranean Avenue", 60, 1, false));
				boardList.add(new Board("Community Chest", 0, 2, false));
				boardList.add(new Board("Baltic Avenue", 60, 3, false));
				boardList.add(new Board("Income Tax", 0, 4, false));
				boardList.add(new Board("Reading Railroad", 200, 5, false));
				boardList.add(new Board("Oriental Avenue", 100, 6, false));
				boardList.add(new Board("Chance", 0, 7, false));
				boardList.add(new Board("Vermont Avenue", 100, 8, false));
				boardList.add(new Board("Connecticut Avenue", 120, 9, false));
				boardList.add(new Board("Visiting Jail", 0, 10, false));
				boardList.add(new Board("St. Charles Place", 140, 11, false));
				boardList.add(new Board("Electric Company", 150, 12, false));
				boardList.add(new Board("States Avenue", 140, 13, false));
				boardList.add(new Board("Virginia Avenue", 160, 14, false));
				boardList.add(new Board("Pennsylvania Raiload", 200, 15, false));
				boardList.add(new Board("St. James Place", 180, 16, false));
				boardList.add(new Board("Community Chest", 0, 17, false));
				boardList.add(new Board("Tennessee Avenue", 180, 18, false));
				boardList.add(new Board("New York Avenue", 200, 19, false));
				boardList.add(new Board("Free Parking", 0, 20, false));
				boardList.add(new Board("Kentucky Avenue", 220, 21, false));
				boardList.add(new Board("Chance", 0, 22, false));
				boardList.add(new Board("Indiana Avenue", 220, 23, false));
				boardList.add(new Board("Illinois Avenue", 240, 24, false));
				boardList.add(new Board("B&O Railroad", 200, 25, false));
				boardList.add(new Board("Atlantic Avenue", 260, 26, false));
				boardList.add(new Board("Ventnor Avenue", 260, 27, false));
				boardList.add(new Board("Water Works", 150, 28, false));
				boardList.add(new Board("Marvin Gardens", 280, 29, false));
				boardList.add(new Board("Go To Jail", 0, 30, false));
				boardList.add(new Board("Pacific Avenue", 300, 31, false));
				boardList.add(new Board("North Caroline Avenue", 300, 32, false));
				boardList.add(new Board("Community Chest", 0, 33, false));
				boardList.add(new Board("Pennsylvania Avenue", 320, 34, false));
				boardList.add(new Board("Short Line Railroad", 200, 35, false));
				boardList.add(new Board("Chance", 0, 36, false));
				boardList.add(new Board("Park Place", 350, 37, false));
				boardList.add(new Board("Luxury Tax", 0, 38, false));
				boardList.add(new Board("Boardwalk", 400, 39, false));
