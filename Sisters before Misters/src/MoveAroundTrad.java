...
public class MoveAroundTrad
	{
		...
		public static void moveSpaces()
		{
			...
			else if(MonopolyRunner.player1.getPlace() + Dice.diceRoll <= 39)
			{
				...
				System.out.println("You landed on: " + BoardArrayList.tradBoard.get(newPlace).getName());
			...
			else if(MonopolyRunner.player1.getPlace() + Dice.diceRoll > 40)
			{
				...
				System.out.println("You are on: " + BoardArrayList.tradBoard.get(newPlaceP3 - 1).getName());
			}
		...
		public static void moveSpaces2()
		{
			...
			else if(MonopolyRunner.player2.getPlace() + Dice.diceRoll <= 39)
			{
				...
				//comment these bottom two lines out for free parking test
				System.out.println("You landed on: " + BoardArrayList.tradBoard.get(newPlaceP2).getName());
			...
			else if(MonopolyRunner.player2.getPlace() + Dice.diceRoll > 40)
			{
				...
				System.out.println("You are on: " + BoardArrayList.tradBoard.get(newPlace3 - 1).getName());
			}
